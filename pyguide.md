...
(`"""Fetches rows from a Bigtable."""`) rather than imperative-style (`"""Fetch rows from a Bigtable."""`), except for `@property` data descriptors, which
...
hanging indent style as described in _Args:_. You should not document
...
[_Type Comments:_](#type-comments)
